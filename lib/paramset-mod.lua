-- copied from norns source lua/core/paramset.lua
-- modified to allow params to be tied to a UI element separately from their action
--
...
local prefix = '7u-patch-companion/lib/params-mod/'
local binary = require(prefix..'binary')
